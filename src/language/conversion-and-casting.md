...
Both Java and Rust are statically-typed at compile time. Hence, after a variable
...
are several ways to convert types in Java that have an equivalent in Rust.

## Implicit conversions

Implicit conversions exist in Java as well as in Rust (called [type coercions]).
